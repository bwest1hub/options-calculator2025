...
K = st.number_input("Strike Price (K)", value=4.00, min_value=0.01, step=0.01, format="%.2f")
premium = st.number_input("Option Premium", value=2.65, min_value=0.01, step=0.01, format="%.2f")
